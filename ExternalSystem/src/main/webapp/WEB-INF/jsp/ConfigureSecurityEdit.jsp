	...
	<div id="page-content-wrapper" >
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <!--order table form-->
                        <form:form class="form-horizontal" modelAttribute="securityEdit">
                           
                            <div class="form-group" class="left">
                                <label class="control-label col-sm-3" for="symbol" >Symbol</label>
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="symbol" min="0" path="symbol" readonly="true" />
                                </div>
                            </div>
                            <div class="form-group" class="left">
                                <label class="control-label col-sm-3" for="name" >Name</label>
                                <div class="col-sm-9">
                                    <form:input type="text" class="form-control" id="name" min="0" path="name" readonly="true" />
                                </div>
                            </div>
                             ...
                             <div class="form-group" >
                                ...
                                <div class="col-sm-9">
                                    <form:input type="number" class="form-control" id="price" min="0" placeholder="Enter Last Traded Price" path="lastTradedPrice" readonly="true"/>
                                </div>
                            </div>
